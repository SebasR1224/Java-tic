...
//        this.password.setText("12345678");
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/img/login.png"))); // NOI18N
    ...
    public void login(){
        ...
        if(this.username.getText().equals("") || this.password.getText().equals("")){
            ...
            cliente = dao.login(username, password);
            if(cliente.getUsername() != null && cliente.getPassword() != null){
                Index index = new Index();
                index.setVisible(true);
                dispose();
            }else{
                JOptionPane.showMessageDialog(this, "Datos de inicio de sesión incorrectos");
                this.username.requestFocus();
            }
        }
    }
